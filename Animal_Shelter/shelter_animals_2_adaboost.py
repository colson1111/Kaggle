...
# create weak learner
stump = DecisionTreeClassifier(max_depth = 5, min_samples_leaf = 1)

# create adaboost classifier
clf = AdaBoostClassifier(base_estimator = stump, n_estimators = 1000)



adaboost = Pipeline([("imputer", Imputer(missing_values = "NaN", 
                                       strategy = "median",
                                       axis = 0)),
                   ("adaboost", clf)])
...
# random forest, 500 estimators log loss: 0.971
# random forest, 1000 estimators log loss: 0.920
# adaboost, 100 estimators, decision tree classifier base, log loss: 1.57
# adaboost, 500 estimators, decision tree classifier base, log loss: 1.48
